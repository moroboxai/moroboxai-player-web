(function (global, factory) {
            ...
            return new Promise((resolve) => {
                ...
                if (options.url !== undefined) {
                    fetch(options.url)
                        ...
                        .then((code) => loadFromCode(options.type !== undefined
                        ? options.type
                        : typeFromUrl(options.url), code));
                }
    ...
    */
    ...
    // SDK version
    const VERSION$1 = "0.1.0-alpha.27";
        ...
        _loadBoot() {
            ...
            if (boot !== undefined) {
                ...
                if (boot.startsWith("http")) {
                    // direct URL
                    return fetch((_a = this.header) === null || _a === void 0 ? void 0 : _a.boot)
                        .then((res) => {
                        if (!res.ok) {
    ...
    exports.GAME_SDK_VERSION = VERSION$1;
